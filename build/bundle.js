...
/***/ function(module, exports, __webpack_require__) {
	      ...
	      React.createElement(
	        ...
	        this.state.people.map(function (person) {
	          return React.createElement(
	            ...
	            { key: person._id },
	            person._id,
	            React.createElement(EditPerson, { person: person, onDelete: this.handleDelete, onEdit: this.handleEdit })
	          );
	        }.bind(this))
	      ),
	      React.createElement(NewPerson, { onCommentSubmit: this.handleNewPerson })
	    );
	  }
	});
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement('input', { onClick: this.handleSubmit, type: 'submit', value: 'Update' })
	      )
	    );
	  }
	});
	...
	var NewPerson = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      'form',
	      { className: 'newForm', onSubmit: this.handleSubmit },
	      React.createElement('input', { name: 'name', type: 'text', value: this.state.name, placeholder: 'Name', onChange: this.handleNameChange }),
	      React.createElement('input', { name: 'submit', type: 'submit', value: 'POST' })
	    );
	  }
	});

	ReactDOM.render(React.createElement(People, { url: 'http://localhost:3000/api/person' }), document.getElementById('get'));
